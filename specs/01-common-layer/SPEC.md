...
The Common Layer provides universal building blocks used across all agent implementations in Sforza. These are foundational templates, skills, personalities, and utilities that any team template or standalone agent can reference.
